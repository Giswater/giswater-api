...
from ..models.hydraulic_engine_ud_models import NodeValueUpdate, LinkValueUpdate, PumpValueUpdate, OverflowValueUpdate, ControlValueUpdate

router = APIRouter(prefix="/hydraulicengine/ud", tags=["Hydraulic Engine (UD)"])

def get_network_scenario(networkScenario: str = Query(..., description="SWMM network scenario")):
...
async def get_swmm_file(
    ...
    return {"message": "Fetched SWMM file successfully", "networkScenario": networkScenario}

@router.post("/setswmmfile")
async def set_swmm_file(
    networkScenario: str = Depends(get_network_scenario)
):
    return {"message": "SWMM file attributes modified successfully", "networkScenario": networkScenario}
...
async def set_node_value(
    ...
    return {"message": "Node value modified successfully", "networkScenario": networkScenario, "update": update}
...
async def set_link_value(
    ...
    return {"message": "Link value modified successfully", "networkScenario": networkScenario, "update": update}
...
async def set_pump_value(
    ...
    return {"message": "Pump value modified successfully", "networkScenario": networkScenario, "update": update}
...
async def set_overflow_value(
    ...
    return {"message": "Overflow value modified successfully", "networkScenario": networkScenario, "update": update}
...
async def set_swmm_result(
    ...
    return {"message": "SWMM result set successfully", "networkScenario": networkScenario, "result": result}
...
async def set_solve_time(
    ...
    return {"message": "Solve time set successfully", "networkScenario": networkScenario, "time": time}
...
async def set_control_value(
    ...
    return {"message": "Control value modified successfully", "networkScenario": networkScenario, "update": update}
